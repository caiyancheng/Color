...
def scale_inter_intra(observer_id_list, condition_id_list, quality_list, no_delta=True):
    ...
    if no_delta:
        ...
        # par_rec_Powell = minimize(log_likelihood_no_delta, par_0, method='Powell')
        par_rec_LBFGSB = minimize(log_likelihood_no_delta, par_0, method='L-BFGS-B')
        # par_rec_trust_constr = minimize(log_likelihood_no_delta, par_0, method='trust-constr')
        ...
        # elif par_rec_trust_constr['fun'] <= par_rec_Powell['fun'] and par_rec_trust_constr['fun'] <= par_rec_LBFGSB['fun']:
